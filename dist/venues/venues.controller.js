...
let VenuesController = class VenuesController {
    ...
    findAll(uploaderEmail) {
        return this.venuesService.findAll(uploaderEmail.uploaderEmail);
    }
    findAllowedVenues(id, uploaderEmail) {
        return this.venuesService.allowedForAccount(Number(id), uploaderEmail.uploaderEmail);
    }
    update(id, updateVenueDto) {
        return this.venuesService.update(+id, updateVenueDto);
    }
    remove(id, uploaderEmail) {
        return this.venuesService.remove(Number(id), uploaderEmail.uploaderEmail);
    }
};
...
__decorate([
    (0, common_1.Get)('/allowed-for-account'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], VenuesController.prototype, "findAllowedVenues", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
